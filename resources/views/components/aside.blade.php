...
Produk Terlaris
    ...
    <?php
    $featured = array(
        array('id' => '1', 'url' => 'http://x', 'title' => 'judul', 'price' => '924773','image'=>'imagepath'),
        array('id' => '2', 'url' => 'http://x', 'title' => 'judul', 'price' => '924773','image'=>'imagepath'),
        array('id' => '3', 'url' => 'http://x', 'title' => 'judul', 'price' => '924773','image'=>'imagepath'),
        array('id' => '4', 'url' => 'http://x', 'title' => 'judul', 'price' => '924773','image'=>'imagepath'),
    );
    // dd($featured);
    foreach ( $featured as $key => $val){ 
        $fitur = $featured[$key]; //$item;
        $site = $fitur;
        $item = $site;// dd($fitur);
        // var_dump($fitur); //$key;
        // echo $item[0];
